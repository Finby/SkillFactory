...
public class App {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("""
               To check game you need to enter:
               'exit' - to exit
               'replay' - to restart game
               'castling0' or 'castling7' 
               'move 1 1 2 3' - to move Piece from 1 1 to 2 3(field is array from 0 to 7)
               Check if pieces can pass through another pieces, 
               correctly beats each another, 
               correctness of rokirovka?""");
        System.out.println();
        board.printBoard();
        while (true) {
            ...
            if (s.equals("exit")) break;
                ...
                if (s.equals("castling0")) {
                    if (board.castling0()) {
                        System.out.println("rocirovka is successful");
                        board.printBoard();
                    } else {
                        System.out.println("rocirovka is NOT successful");
                    }
                    ...
                    try {
                        ...
                        System.out.println("something entered incorrectly, try again");
                    }
